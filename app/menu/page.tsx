...
export default function MenuPage() {
  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(rgba(10,10,15,0.55), rgba(10,10,15,0.65)), url(https://i.pinimg.com/736x/a0/e8/62/a0e862a298652353eeecba4aabe7564a.jpg) center/cover fixed', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  if (!shopOpen) return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(rgba(10,10,15,0.55), rgba(10,10,15,0.65)), url(https://i.pinimg.com/736x/a0/e8/62/a0e862a298652353eeecba4aabe7564a.jpg) center/cover fixed', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(rgba(10,10,15,0.55), rgba(10,10,15,0.65)), url(https://i.pinimg.com/736x/a0/e8/62/a0e862a298652353eeecba4aabe7564a.jpg) center/cover fixed', paddingBottom: '100px' }}>
      {/* Header */}
      <div style={{
